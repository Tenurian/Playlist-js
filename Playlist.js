            ...
            if (links) {
                if (links.length == 0) {
                    ...
                    for (i = 0; i < links.length; i++) {
                        ...
                        content += "<div clear='both'><span id='controls-" + i + "' class='controls left " + ((i == SongList[currentSong]) ? "" : "hidden") + "'>"
